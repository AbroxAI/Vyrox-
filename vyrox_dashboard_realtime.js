(() => {
    ...
    /*
     * VYROX REALTIME DASHBOARD
     *
     * GitHub frontend -> Telegram Mini App -> Colab API
     *
     * The live API URL is supplied automatically through:
     *
     * https://abroxai.github.io/Vyrox-/?api=YOUR_COLAB_API
     *
     * No mock trading data.
     * No Math.random() simulator.
     */
    ...
    const API_BASE =
        ...
        ||
        window.VYROX_API_BASE
        ||
        "";

    const CONFIG = {
        statusUrl:
            `${API_BASE}/api/vyrox/status`,

        controlUrl:
            `${API_BASE}/api/vyrox/control`,

        telegramTestUrl:
            `${API_BASE}/api/vyrox/telegram/test`,
